                        ...
                        egui::Frame::popup(ui.style())
                            .show(ui, |ui| {
                                ...
                                if show_both_columns {
                                    ...
                                    ui.horizontal(|ui| {
                                        ui.label(phosphor_rich_text(FOLDER, 12.0).font(crate::fonts::chrome_bold_font(crate::theme::typescale::chrome::BODY)));
                                        ui.label(
                                            egui::RichText::new(
                                    ...
                                    ui.set_min_width(300.0);
                                    ui.horizontal(|ui| {
                                        ui.label(phosphor_rich_text(FILE_TEXT, 12.0).font(crate::fonts::chrome_bold_font(crate::theme::typescale::chrome::BODY)));
                                        ui.label(
                                            egui::RichText::new(
