...
//! Kotori Skrivr - Main Entry Point
//!
...
/// Kotori Skrivr - A fast, lightweight text editor for Markdown, JSON, and more.
#[derive(Parser, Debug)]
#[command(name = "skrivr", version, about, long_about = None)]
struct Cli {
...
fn main() -> eframe::Result<()> {
    // Trace file works in release (no console on Windows). Check %TEMP%\skrivr_startup_trace.log
